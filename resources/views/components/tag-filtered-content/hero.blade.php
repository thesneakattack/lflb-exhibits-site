    ...
    <section class="relative w-full text-white overflow-hidden">
        @if ($orientation === 'portrait')
            <div class="absolute inset-0 -z-10">
                <img src="{{ $background }}" alt="{{ $story->title }}" class="w-full h-full object-cover @if($orientation === 'portrait') lg:blur-sm lg:brightness-75 lg:scale-105 @endif">
        ...
        <div class="container mx-auto px-6 pt-6 pb-12 flex flex-col lg:flex-row items-start gap-8 md:h-full lg:h-[30vh]">
            <div class="lg:w-1/2 relative z-10 flex flex-col justify-between h-full">
                ...
                <div class="mt-auto">
                    ...
                    <div class="w-fit">
                        <a href="/story/{{ $story->id }}" class="inline-flex flex-wrap items-center gap-2 bg-red-600 text-white px-4 py-2 rounded shadow hover:bg-red-700 transition">
                            Read More
                        </a>
                    </div>
                </div>
